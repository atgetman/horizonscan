    ...
    <div className="flex h-full w-full bg-[#FCFCFC]">
      ...
      <div className="flex-1 h-full flex flex-col relative">
        ...
        <div className="w-full max-w-[750px] mx-auto pb-8" data-tour-step="1">
            ...
            />
            <p className="mt-3 text-center text-[13px] text-[#8a8a8a] font-['Source_Sans_3']">
              Generated by AI. Not legal or tax advice. A qualified professional must verify accuracy and legal compliance.
            </p>
        </div>
