...
function ProgressBar() {
  return (
    <div className="bg-[#0062c4] content-stretch flex flex-col h-[4px] items-center overflow-clip relative rounded-[4px] shrink-0 w-full" data-name="progress-bar">
      <div className="bg-[#0062c4] flex-[1_0_0] min-h-px opacity-0 w-full" data-name="vector-progress-bar" />
    </div>
  );
}
...
function MainContent() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="main-content">
      <Label />
      <div className="bg-[#ededed] relative rounded-[4px] shrink-0 w-full" data-name="saf-progress-bar">
