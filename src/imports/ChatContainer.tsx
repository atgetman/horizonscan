        ...
        <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full">
          <div className="content-stretch flex flex-col gap-[12px] items-center relative shrink-0 w-[720px]">
            <div className="content-stretch flex gap-[10px] items-center justify-center not-italic relative shrink-0">
              <div className="flex flex-col font-['Font_Awesome_6_Sharp:Solid',sans-serif] justify-center leading-[0] relative shrink-0 text-[#de6633] text-[16px] text-center text-shadow-[0px_4px_33px_rgba(247,93,27,0.4)] whitespace-nowrap">
                <p className="leading-[normal]"></p>
              </div>
              <p className="font-['Clario:Medium',sans-serif] leading-[1.2] relative shrink-0 text-[#666] text-[20px]">Good morning, Dan</p>
            </div>
            <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 text-center">
              ...
              <p className="font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[1.35] relative shrink-0 text-[#404040] text-[15px] w-[712px] whitespace-pre-wrap">{`CoCounsel can handle multiple tasks in a single request—just tell it everything you need. `}</p>
            </div>
          </div>
