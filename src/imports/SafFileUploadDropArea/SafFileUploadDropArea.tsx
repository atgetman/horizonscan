...
export default function SafFileUploadDropArea() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[8px] items-center justify-center p-[12px] relative rounded-[8px] size-full" data-name="saf-file-upload-drop-area">
