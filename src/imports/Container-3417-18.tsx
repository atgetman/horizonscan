import svgPaths from "./svg-8pg7nifhfk";
...
function Text() {
  return (
    <div className="absolute h-[20px] left-[32px] top-[10px]" data-name="Text">
...
function Icon1() {
  return (
    <div className="h-[6px] relative shrink-0 w-[8px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8 6">
        <g clipPath="url(#clip0_3413_193)" id="Icon">
          <path d="M1 3L3 5L7 1" id="Vector" stroke="var(--stroke-0, #1D4B34)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </g>
        <defs>
          <clipPath id="clip0_3413_193">
            <rect fill="white" height="6" width="8" />
          </clipPath>
        </defs>
      </svg>
    </div>
...
function Container2() {
  return (
    <div className="bg-white h-[12px] relative rounded-[16777200px] shrink-0 w-full" data-name="Container">
...
function Container1() {
  return (
    <div className="absolute bg-[#1d4b34] content-stretch flex flex-col h-[16px] items-start left-[169.57px] pl-[18px] pr-[2px] pt-[2px] rounded-[16777200px] top-[12px] w-[32px]" data-name="Container">
      <Container2 />
    </div>
  );
}
...
export default function Container() {
  return (
    <div className="bg-white border border-[#e5e7eb] border-solid relative rounded-[16777200px] shadow-[0px_2px_4px_0px_rgba(0,0,0,0.06),0px_1px_2px_0px_rgba(0,0,0,0.04)] size-full" data-name="Container">
      <Icon />
      <Text />
      <Container1 />
    </div>
